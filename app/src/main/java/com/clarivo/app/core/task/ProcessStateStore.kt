...
class ProcessStateStore(context: Context) {
    ...
    fun saveCurrentTask(task: ProcessTask) {
        try {
            ...
            ClarivoLogger.e("Failed to save current task", e)
        }
    }
    ...
    fun loadCurrentTask(): ProcessTask? {
        return try {
            ...
            ClarivoLogger.e("Failed to load current task", e)
            null
        }
    }
    ...
    fun archiveTask(task: ProcessTask) {
        try {
            ...
            ClarivoLogger.e("Failed to archive task", e)
        }
    }
    ...
    fun saveResult(
        ...
        try {
            ...
            ClarivoLogger.e("Failed to save task result", e)
        }
    }
    ...
    fun loadResult(taskId: String): StoredProcessResult? {
        return try {
            ...
            ClarivoLogger.e("Failed to load task result", e)
            null
        }
    }
    ...
    fun deleteTask(taskId: String) {
        try {
            ...
            ClarivoLogger.i("Task deleted: $taskId")
        } catch (e: Exception) {
            ClarivoLogger.e("Failed to delete task: $taskId", e)
        }
    }
    ...
    fun clearHistory() {
        try {
            ...
            ClarivoLogger.i("History cleared")
        } catch (e: Exception) {
            ClarivoLogger.e("Failed to clear history", e)
        }
    }
