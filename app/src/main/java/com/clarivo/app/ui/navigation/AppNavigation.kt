package com.clarivo.app.ui.navigation
...
import com.clarivo.app.ui.component.BottomNavBar
...
import com.clarivo.app.ui.navigation3.MainPagerState
import com.clarivo.app.ui.navigation3.Navigator
import com.clarivo.app.ui.navigation3.Route
import com.clarivo.app.ui.navigation3.rememberMainPagerState
import com.clarivo.app.ui.screen.about.AboutScreen
import com.clarivo.app.ui.screen.home.HomeScreen
import com.clarivo.app.ui.screen.home.PermissionSettingsScreen
import com.clarivo.app.ui.screen.process.ProcessSettingsScreen
import com.clarivo.app.ui.screen.processing.ProcessingScreen
import com.clarivo.app.ui.screen.result.ResultDetailScreen
import com.clarivo.app.ui.screen.settings.SettingsScreen
import com.clarivo.app.ui.screen.settings.ThemeSettingsScreen
import com.clarivo.app.ui.screen.task.TaskListScreen
...
import com.clarivo.app.ui.animation.predictiveback.MiuixPredictiveBackAnimation
import com.clarivo.app.ui.animation.predictiveback.NoPredictiveBackAnimation
...
import com.clarivo.app.viewmodel.TaskViewModel
        ...
        val entries = rememberDecoratedNavEntries(
            ...
            entryProvider = entryProvider {
                ...
                entry<Route.ModelManager> { route: Route.ModelManager ->
                    com.clarivo.app.ui.screen.modelmanager.ModelManagerScreen(
...
private fun MainPager(
    ...
    CompositionLocalProvider(
        com.clarivo.app.ui.navigation3.LocalMainPagerState provides mainPagerState
    ) {
...
private fun MainScreenWithNavBar(
    ...
    val mainPagerState = com.clarivo.app.ui.navigation3.LocalMainPagerState.current
    ...
    when (LocalUiMode.current) {
        UiMode.Miuix -> MiuixScaffold(
            ...
            CompositionLocalProvider(
                LocalClarivoMiuixBottomSpacing provides bottomSpacing
            ) {
                Box(
                    modifier = Modifier
