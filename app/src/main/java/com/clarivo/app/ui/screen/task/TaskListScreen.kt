package com.clarivo.app.ui.screen.task
...
import com.clarivo.app.ui.component.ClarivoMaterialLogEntryItem
import com.clarivo.app.ui.component.ClarivoMaterialMessageCard
import com.clarivo.app.ui.component.ClarivoMaterialSegmentedColumn
import com.clarivo.app.ui.component.ClarivoMiuixLogEntryCard
import com.clarivo.app.ui.component.DeleteConfirmDialog
import com.clarivo.app.ui.component.ClarivoMiuixMessageCard
import com.clarivo.app.ui.component.LocalClarivoMiuixBottomSpacing
import com.clarivo.app.ui.component.SearchStatus
import com.clarivo.app.ui.component.material.ClarivoMaterialSearchAppBar
import com.clarivo.app.ui.component.miuix.ClarivoSearchBarFake
import com.clarivo.app.ui.component.miuix.SearchBox
import com.clarivo.app.ui.component.miuix.SearchPager
...
import com.clarivo.app.viewmodel.TaskFilter
import com.clarivo.app.viewmodel.TaskItem
            ...
            searchStatus.SearchPager(
                ...
                result = {
                    LazyColumn(
                        ...
                        item {
                            Spacer(Modifier.height(LocalClarivoMiuixBottomSpacing.current + 12.dp))
                        }
                    }
                }
            )
                ...
                searchContent = { bottomPadding, _ ->
                    LazyColumn(
                        ...
                        if (tasks.isEmpty()) {
                            ...
                            item {
                                ClarivoMaterialSegmentedColumn(itemCount = tasks.size) { index ->
                                    val task = tasks[index]
                                    ClarivoMaterialLogEntryItem(
                                        title = task.fileName,
                                        description = processModeLabel(task.processMode),
                                        timestamp = taskCompletionText(task),
                                        tags = listOf(taskTypeTag(task.isRealtime)),
