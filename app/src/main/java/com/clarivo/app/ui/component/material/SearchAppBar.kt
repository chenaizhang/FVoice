package com.clarivo.app.ui.component.material
...
/**
 * Material-style search app bar matching the SULog page search experience.
 *
 * Combines a [LargeFlexibleTopAppBar] with a Material3 [SearchBar] and an
 * [ExpandedFullScreenContainedSearchBar] for the full-screen search results.
 */
@OptIn(ExperimentalMaterial3Api::class, ExperimentalMaterial3ExpressiveApi::class)
@Composable
fun ClarivoMaterialSearchAppBar(
    ...
    val isSearchExpanded = searchBarState.currentValue != SearchBarValue.Collapsed ||
    ...
    LaunchedEffect(searchBarState) {
        snapshotFlow { searchBarState.currentValue }
            .distinctUntilChanged()
            .collect { value ->
                val collapsedFromExpanded = previousSearchBarValue != SearchBarValue.Collapsed &&
                        value == SearchBarValue.Collapsed
