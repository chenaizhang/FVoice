...
import com.clarivo.app.ui.component.material.SendLogBottomSheet
import com.clarivo.app.ui.component.miuix.SendLogDialog
...
fun SettingsMiuix(
    ...
    ClarivoMiuixPage(title = stringResource(R.string.nav_settings)) {
        item {
