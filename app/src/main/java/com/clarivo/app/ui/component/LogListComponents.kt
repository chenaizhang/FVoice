...
@Composable
fun ClarivoMiuixSearchFilterCard(
    query: String,
...
@Composable
private fun ClarivoMiuixStatusTags(tags: List<String>) {
    ...
    Row(horizontalArrangement = Arrangement.spacedBy(4.dp)) {
        ...
        tags.forEachIndexed { index, tag ->
            ...
            ClarivoMiuixStatusTag(label = tag, backgroundColor = bg, contentColor = fg)
        }
    }
}

@Composable
fun ClarivoMiuixStatusTag(
    label: String,
    modifier: Modifier = Modifier,
...
@Composable
fun ClarivoMaterialSearchFilterCard(
    query: String,
    onQueryChange: (String) -> Unit,
    placeholder: String,
    dropdownTitle: String,
...
val LocalClarivoSegmentShape = compositionLocalOf { RoundedCornerShape(0.dp) }

@Composable
fun ClarivoMaterialSegmentedColumn(
    modifier: Modifier = Modifier,
    itemCount: Int,
    ...
    Column(
        ...
        repeat(itemCount) { index ->
            CompositionLocalProvider(
                LocalClarivoSegmentShape provides clarivoSegmentShape(index, itemCount),
            ) {
                content(index)
            }
        }
...
@Composable
fun ClarivoMaterialLogEntryItem(
    title: String,
    description: String?,
    timestamp: String?,
    tags: List<String>,
    ...
    Surface(
        ...
        shape = LocalClarivoSegmentShape.current,
        ...
        Row(
            ...
            Column(
                ...
                ClarivoMaterialStatusTags(tags)
            }
            status?.let {
                Text(
                    text = it,
...
@Composable
fun ClarivoMaterialMessageCard(
    title: String,
    summary: String? = null,
    modifier: Modifier = Modifier,
) {
...
@Composable
private fun ClarivoMaterialStatusTags(tags: List<String>) {
    if (tags.isEmpty()) return
    Row(horizontalArrangement = Arrangement.spacedBy(2.dp)) {
        ...
        tags.forEachIndexed { index, tag ->
            val (bg, fg) = colors.getOrElse(index) { colors.last() }
            ClarivoMaterialStatusTag(label = tag, backgroundColor = bg, contentColor = fg)
        }
    }
}

@Composable
fun ClarivoMaterialStatusTag(
    label: String,
    modifier: Modifier = Modifier,
    backgroundColor: Color,
    contentColor: Color,
...
private fun clarivoSegmentShape(index: Int, count: Int): RoundedCornerShape {
    val radius = 18.dp
    val middle = 6.dp
    return when {
