...
object LogCollector {
    ...
    fun collect(context: Context): File {
        ...
        appLogsDir.mkdirs()
        ClarivoLogger.getLogFiles().forEach { logFile ->
        ...
        val targetFile = File(context.cacheDir, "Clarivo_bugreport_${current}.zip")
