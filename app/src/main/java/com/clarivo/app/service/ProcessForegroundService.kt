package com.clarivo.app.service
...
import com.clarivo.app.notification.NotificationHelper
...
class ProcessForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_CANCEL = "com.clarivo.app.CANCEL_TASK"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        serviceScope.launch {
            taskManager.resultEvent.collect { result ->
                ...
                when (result) {
                    is com.clarivo.app.core.model.ProcessResult.Success -> {
                    ...
                    is com.clarivo.app.core.model.ProcessResult.Failure -> {
                    ...
                    is com.clarivo.app.core.model.ProcessResult.Cancelled -> {
